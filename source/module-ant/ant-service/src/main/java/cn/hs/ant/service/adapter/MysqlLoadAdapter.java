 ...
 * @author swt
 */
public class MysqlLoadAdapter implements LoadAdapter {
    private static Log log = LogFactory.getLog(MysqlLoadAdapter.class);
    private MysqlDataTerminal dataTerminal;
    private String tableName;
    private List<String> columnNameList;
    private List<Integer> columnTypeList;

    public MysqlLoadAdapter(DataTerminal dataTerminal) {

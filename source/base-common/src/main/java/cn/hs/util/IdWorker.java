...
public class IdWorker {
    ...
    private long sequenceBits = 9L; // 序列号12位
    ...
    public synchronized long nextId() {
        ...
        // job datacenterId workerId sequence
    ...
    public static void main(String[] args) {
		...
		for(int i = 0; i < 10000000; i++) {
		    s.add(IdWorker.getInstance().nextStringId());
		}
		System.out.println(s.size());
        System.out.println(IdWorker.getInstance().nextStringId());*/
    }
